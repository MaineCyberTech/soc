...
This is a white-label sample generated from brand/client profile config.
...
- No actionable threats at baseline.

## SCA and vulnerability

- CIS benchmarks tracked. Vulnerability scan pending authorization.
