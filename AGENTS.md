...
- Current operational truth: `ops/reports/canonical/current/current-state-20260829-p70.md`
...
in the canonical current-state doc: `ops/reports/canonical/current/current-state-20260829-p70.md`
