...
- Current operational truth: `ops/reports/canonical/current/current-state-20260829-p69.md`
...
in the canonical current-state doc: `ops/reports/canonical/current/current-state-20260829-p69.md`
