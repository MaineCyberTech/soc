...
- Current operational truth: the latest current-state doc in
  ...
  live truth is `ops/reports/canonical/current/current-state-20260831-p81.md` (Phase 81;
  all 9 p81 validators PASS; see also `ops/reports/current/final-phase81-operator-report-20260831T0500Z.md`).
  Do not act on any
