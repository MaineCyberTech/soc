...
- Current operational truth: `ops/reports/canonical/current/current-state-20260828-p68.md`
  (Phase 68 hardening refresh; supersedes `current-state-20260828-p67.md` per its own
...
in the canonical current-state doc: `ops/reports/canonical/current/current-state-20260828-p68.md`
