...
- Current operational truth: `ops/reports/canonical/current/current-state-20260828-p67.md`
  (Phase 67 refresh; supersedes `current-state-20260828-p66.md` per its own
...
in the canonical current-state doc: `ops/reports/canonical/current/current-state-20260828-p67.md`
