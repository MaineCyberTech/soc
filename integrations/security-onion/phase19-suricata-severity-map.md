# Phase 19 Suricata Severity Map (draft - gated on event validation)

Date: 2026-08-18
Status: **PLAN ONLY - NOT ACTIVE.** Rules/routing stay gated until Suricata events ingest and validate (see phase19-suricata-ingest-check.md).
