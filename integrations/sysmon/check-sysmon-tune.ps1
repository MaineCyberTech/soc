...
.DESCRIPTION
  Reports Sysmon service state, policy/deployed config hashes, backup inventory, and EID7 channel activity. No changes are made. This script is self-contained (policy XML embedded) and requires no parameters -
