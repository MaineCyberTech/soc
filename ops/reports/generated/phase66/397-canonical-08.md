# Phase 66: Canonical 08

**Report ID:** phase66-397-canonical-08
**Phase:** 66
**Title:** Canonical 08
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase66/397-canonical-08.md
...
## Evidence
Canonical truth advances to current-state-20260828-p66.md: genuine Wazuh->Shuffle->IRIS delivery proven and PERSISTENT (manager on mct-security + real key; execution 593b3840-0565-4d46-8574-c676cc7f54a8 -> IRIS Routed 200); OW-65-01 RESOLVED; OW-66-01 OPEN (stale ops-vault IRIS key blocks read-back); single supervisor certified; stale-lock recovery present.
