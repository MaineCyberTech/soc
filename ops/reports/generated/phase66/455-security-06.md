# Phase 66: Security 06

**Report ID:** phase66-455-security-06
**Phase:** 66
**Title:** Security 06
**Date:** 2026-08-28
...
**Status:** PARTIAL
**Source Path:** ops/reports/generated/phase66/455-security-06.md
...
## Evidence
Security posture: Shuffle TLS :3443; live ossec.conf api_key is the REAL key only in the host bind-mount (root:wazuh 640), never in the repo. LIMITATION (OW-66-01): the ops-vault IRIS_API_KEY is stale (401); it is a read-only read-back credential and its staleness is documented, not a production delivery risk. Staged-deploy keeps secrets out of repo.
