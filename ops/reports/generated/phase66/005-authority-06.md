# Phase 66: Authority 06

**Report ID:** phase66-005-authority-06
**Phase:** 66
**Title:** Authority 06
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase66/005-authority-06.md
...
## Evidence
AGENTS.md is DURABLE-ONLY: it holds directives and pointers, never volatile metrics. Canonical current-state pointer advances to current-state-20260828-p66.md (this phase). Per-phase truth lives under ops/reports/canonical/current/. Required gates (secret scan, redaction, metadata compliance, phase CI) precede commit.
