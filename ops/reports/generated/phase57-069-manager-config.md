**Report ID:** phase57-069-manager-config
**Phase:** 57
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-069-manager-config.md
...
## Evidence (layered)
manager ossec.conf shuffle integration: hook_url=http://shuffle-backend:5001/api/v1/hooks/webhook_e3fec000-555f-4e81-9497-77b7c91c5b98 level=10 api_key=placeholder.
