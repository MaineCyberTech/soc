**Report ID:** phase57-115-restart-manager
**Phase:** 57
...
**Status:** DEFERRED
**Source Path:** ops/reports/generated/phase57-115-restart-manager.md
...
## Evidence (layered)
Manager restart to test integratord auto-start = restart gate; deferred.
