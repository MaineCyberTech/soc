**Report ID:** phase57-066-workflow-id
**Phase:** 57
**Title:** Workflow Id
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-066-workflow-id.md
...
## Evidence (layered)
Class-A workflow id = c6b3fcd8-13e5-44a8-a818-024e4ae4422b (verified via API GET with retries).
