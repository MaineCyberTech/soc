# Phase 62: Integratord 02

**Report ID:** phase62-071-integratord-02
**Phase:** 62
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase62/071-integratord-02.md
...
## Evidence
wazuh-integratord RUNNING (PID 603) on wazuh.master-1, monitored by the governed watchdog (PID 2229, auto-started via s6 after the Phase 61 recreate). Restart reliability is deployment-backed, not best-effort.
