# Phase 62: Credential 06

**Report ID:** phase62-025-credential-06
**Phase:** 62
**Title:** Credential 06
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase62/025-credential-06.md
...
## Evidence
Evidence-based credential classification. Runtime status from authoritative sources: IRIS token = rotated value-blind secret (prefix c2173178) in iris-shuffle-env; old literal 31475ce6... gone (literal-detector 0). IRIS read-back used the governed secret directly (not a report string) — independent verification.
