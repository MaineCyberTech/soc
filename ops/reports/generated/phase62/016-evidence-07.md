# Phase 62: Evidence 07

**Report ID:** phase62-016-evidence-07
**Phase:** 62
**Title:** Evidence 07
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase62/016-evidence-07.md
...
## Evidence
Direct evidence: Class-A canary exec 31ebd3f4-7a72-4137-8f9e-2f4e367c6afd -> IRIS ROUTED 200; IRIS alert 74 (and sequential 75-78) independently read back via GET /alerts/74 (Critical/New) with the governed iris-shuffle-env token. Packet exec 66941acc-b011-4e62-b884-69e6f92d4b8e -> ROUTED, destination_object_id 74, counter 5 (authentic). All execution_ids in phase62-states.json are real, verified-present Shuffle executions (authenticity CI).
