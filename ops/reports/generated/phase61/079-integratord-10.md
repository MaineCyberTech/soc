# Phase 61: Integratord 10

**Report ID:** phase61-079-integratord-10
**Phase:** 61
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase61/079-integratord-10.md
...
## Evidence
wazuh-integratord is RUNNING (PID 5203) on wazuh.master-1, monitored by the watchdog (PIDs 4855/5110). integratord reads the live alert queue and forwards level>=10 to the Class-A webhook. Restart reliability is governed by the committed watchdog source.
