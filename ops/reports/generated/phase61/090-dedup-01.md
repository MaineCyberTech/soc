...
**Report ID:** phase61-090-dedup-01
**Phase:** 61
**Title:** Dedup 01
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase61/090-dedup-01.md
...
## Evidence
Packet workflow e133a645-95b9-4e01-9454-e270d2a0b599 dedup is a 6-tuple (sid,src,dst,port,proto,observer) -- no false collapse. Re-verified consistent on the current revision. Duplicates resolve to DUPLICATE state (covered in phase61-states.json).
