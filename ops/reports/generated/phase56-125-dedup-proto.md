# Phase 56: Protocol Difference (must not duplicate)

**Report ID:** phase56-125-125-dedup-proto
**Phase:** 56
**Title:** Protocol Difference (must not duplicate)
**Date:** 2026-08-27
...
**Status:** COMPLETE
**Source Path:** /home/user/mct-p56/prompts/125-dedup-proto.md
**Verdict:** DONE

## Summary
Requirement: events differing only in proto MUST NOT be deduped. CURRENT CODE FAILS: dedup_key omits proto, so TCP vs UDP with identical (sid,src,dst,port) -> identical key -> falsely DUPLICATE. Defect confirmed from source.
...
## Stop conditions
Remediation (add proto to key) gated at 122.

## Limitations
Requirement currently UNMET by live code; fix is owner-gated.
