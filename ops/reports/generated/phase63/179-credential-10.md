# Phase 63: Credential 10

**Report ID:** phase63-179-credential-10
**Phase:** 63
**Title:** Credential 10
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase63/179-credential-10.md
...
## Evidence
Evidence-based credential classification. Runtime: IRIS token = rotated value-blind secret (prefix c2173178) in iris-shuffle-env; old literal 31475ce6... gone (literal-detector 0). Independent read-back used the governed secret.
