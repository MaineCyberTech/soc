**Report ID:** phase57-004-change-register
**Phase:** 57
...
**Status:** COMPLETE
**Source Path:** ops/reports/generated/phase57-004-change-register.md
...
## Evidence (layered)
Change: c6b3fcd8-13e5-44a8-a818-024e4ae4422b IRIS POST literal header -> value-blind execute_python (load_iris_token from /shuffle-files/iris-shuffle.env). Verified ROUTED 200. Backup /tmp/opencode/classa_c6b3fcd8_before-rotation.json (sha 00c3303577545e85).
