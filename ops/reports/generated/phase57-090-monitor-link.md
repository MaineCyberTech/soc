**Report ID:** phase57-090-monitor-link
**Phase:** 57
**Title:** Monitor Link
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-090-monitor-link.md
...
## Evidence (layered)
Link: Wazuh alert -> integratord -> webhook -> Shuffle exec -> IRIS object. All layers confirmed.
