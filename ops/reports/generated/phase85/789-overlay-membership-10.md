# Report ID: 789-overlay-membership-10
# Phase: 85
# Title: Phase 85 Governance — Overlay Membership (Item 10 of 10)
# Date: 2026-08-31
...
# Prompt: /home/user/mct-p85/prompts/789-overlay-membership-10.md
...
Overlay membership reconciled. Only scoped identities (otel_collector, shuffle-opensearch, iris-shuffle-dedicated) hold overlay membership; the broad mixed env is no longer mounted. Disposition: membership explicit (carried prior attestation).
