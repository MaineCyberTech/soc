...
# Phase: 85
# Title: Phase 85 Governance — Agents Durable-Only (Item 10 of 10)
# Date: 2026-08-31
...
# Prompt: /home/user/mct-p85/prompts/869-agents-durable-10.md
...
Root AGENTS is durable-only. No volatile operational metrics are embedded; PVE host access and packet production remain out of scope. Disposition: durable-only affirmed.
