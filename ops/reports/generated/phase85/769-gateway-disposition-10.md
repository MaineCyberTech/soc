# Report ID: 769-gateway-disposition-10
# Phase: 85
# Title: Phase 85 Governance — Gateway Disposition (Item 10 of 10)
# Date: 2026-08-31
...
# Prompt: /home/user/mct-p85/prompts/769-gateway-disposition-10.md
...
Gateway disposition explicit. The IRIS gateway republish on the mct-security gateway and Shuffle worker extra_hosts/secret-mount augmentation are governed by ops/scripts/iris-gateway-publish.sh and ops/scripts/shuffle-worker-augment.sh via cron; these are dev-environment repairs, not new-artifact deploys. Disposition: governed.
