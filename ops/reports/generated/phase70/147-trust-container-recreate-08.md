# Phase 70: Trust Container Recreate 08

**Report ID:** phase70-147-trust-container-recreate-08
**Phase:** 70
**Title:** Trust Container Recreate 08
**Date:** 2026-08-29
**Timestamp:** 2026-08-29T02:25:58Z (UTC) / 2026-08-28 22:25:58 EDT (America/New_York)
**Classification:** INTERNAL
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase70/147-trust-container-recreate-08.md
...
## Evidence
Certificate lifecycle VERIFIED (strict E2E): internal-CA chain (Verify return code 0), SAN iriswebapp_nginx,iris.app.dev,localhost,127.0.0.1, expiry 2036; renewal cert applied + monitor 3649 days OK; 5-day cert triggered expiry ALERT (monitor live); rolled back to original; iriswebapp_nginx recreated with cert surviving and canary ROUTED 200 after restart (ffac5448-3002-4cf9-ac39-97a52ec10563). verify=False eliminated from the effective Class-A path.
