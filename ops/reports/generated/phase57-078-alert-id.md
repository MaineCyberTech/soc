**Report ID:** phase57-078-alert-id
**Phase:** 57
**Title:** Alert Id
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-078-alert-id.md
...
## Evidence (layered)
Wazuh alert id e.g. 1787885415.9900001 (P56); immutable in alerts.json.
