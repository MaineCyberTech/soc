# Partial Success (IRIS accept, ledger write fails) 06

**Report ID:** 345-partial-success-06
**Phase:** 77
**Title:** Phase 77: Partial Success (IRIS accept, ledger write fails) 06
**Date:** 2026-08-30
**Timestamp:** 2026-08-30T08:06:43Z (UTC)
**Timestamp (America/New_York):** 2026-08-30 04:06:43 EDT
**Classification:** INTERNAL
**Status:** PASS
**Source Path:** /opt/mct-security-stack/ops/reports/generated/phase77/345-partial-success-06.md
**Prompt:** 345-partial-success-06.md
...
- Control under test: Partial Success (IRIS accept, ledger write fails) (instance 06).
...
## Action Performed
Executed a reversible, genuine fault injection for workstream "Partial Success (IRIS accept, ledger write fails)" (instance 06) under the Phase 77 execution contract. The production deployed workflow code was NOT modified; a copy of the v2 logic was run in isolation with a controlled, non-persisted fault flag.
