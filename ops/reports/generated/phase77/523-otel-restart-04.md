# Phase 77: Otel Restart 4

**Report ID:** 523-otel-restart-04
**Phase:** 77
**Title:** Phase 77: Otel Restart 4
**Date:** 2026-08-30
**Timestamp:** 2026-08-30T07:54:49Z (UTC)
**Timestamp (America/New_York):** 2026-08-30 03:54:49 EST
**Classification:** INTERNAL
**Status:** PASS
**Source Path:** /opt/mct-security-stack/ops/reports/generated/phase77/523-otel-restart-04.md
**Prompt:** 523-otel-restart-04.md

## Verdict
**PASS**

## Evidence (live, this session)
- sending_queue, telemetry and mem_limit are in bind-mounted collector.yaml / compose (backed up), so they persist across restart/recreate.
