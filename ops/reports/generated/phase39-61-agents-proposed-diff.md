# Phase 39 AGENTS Proposed Diff — Full Proposed /opt/mct-security-stack/AGENTS.md

**Report ID:** phase39-61-agents-proposed-diff
**Phase:** 39
**Title:** Complete Proposed AGENTS.md Text, Every Section Annotated with Source IDs; Ready for Dry Run
**Date:** 2026-08-25
...
**Source Path:** `/opt/mct-security-stack/ops/reports/generated/phase39-61-agents-proposed-diff.md`

---

## 1. Change Shape

- Old state: file absent (phase39-53).
- New state: single root `/opt/mct-security-stack/AGENTS.md` — the FULL text below.
- The `[SRC:]` annotations are part of the applied file (traceability in-repo).

## 2. Full Proposed Text (byte-identical to applied file, sha256 `5a218902…b9b44`)
...
## 3. Section→Source Index

| Section | Sources |
|---|---|
| Header/precedence | phase39-53 |
| Purpose & Scope | phase39-57, phase39-60 |
| Repository Map | phase39-56 (F2/F3), live path sweep |
| Canonical Truth | phase39-56 (F2) |
| Required Gates | phase39-55 S1/S12, phase39-58 validations |
| Safety Rules | phase39-55 §2.1 (pack READMEs p36–p39) |
| Approval-Gated | phase39-56 (F12) |
| Known Blockers | phase39-56 (F10) + blocker reports |
| Credential Handling | phase39-56 (F4), phase39-03…11 arc |
| Report Conventions | phase39-56 (F11), phase38-56/-57/-65 |
| Out of Scope | phase39-55 S10 |
| Owners | phase38-49 §11 |

## Verdict

Proposed diff COMPLETE — handed to dry run (phase39-62).
