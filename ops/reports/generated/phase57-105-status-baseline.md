**Report ID:** phase57-105-status-baseline
**Phase:** 57
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-105-status-baseline.md
...
## Evidence (layered)
integratord running at baseline (wazuh-control status).
