...
**Report ID:** 083
**Phase:** 78
**Title:** IRIS Overlay — dedicated-secret posture
**Date:** 2026-08-30
**Timestamp:** 2026-08-30T20:05:59Z (2026-08-30 16:05:59 EDT)
**Classification:** INTERNAL
**Status:** PASS
**Source Path:** /home/user/mct-p78/prompts/083-iris-overlay-04.md
**Prompt:** 083-iris-overlay-04

## Verdict
PASS — genuine evidence, no fabricated or host-substitute delivery.

## Evidence
Delivery used only the dedicated iris-shuffle-dedicated secret (IRIS_API_KEY + iris-ca.crt) mounted in shuffle-tools, never the broad mixed env. The iris-shuffle-overlay network carried the worker->action path. No host-side substitute was used.
