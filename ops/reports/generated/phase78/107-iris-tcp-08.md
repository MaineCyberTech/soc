...
**Report ID:** 107
**Phase:** 78
**Title:** IRIS Local TCP — action-side connect to 8443
**Date:** 2026-08-30
**Timestamp:** 2026-08-30T20:05:59Z (2026-08-30 16:05:59 EDT)
**Classification:** INTERNAL
**Status:** PASS
**Source Path:** /home/user/mct-p78/prompts/107-iris-tcp-08.md
**Prompt:** 107-iris-tcp-08

## Verdict
PASS — genuine evidence, no fabricated or host-substitute delivery.

## Evidence
In-shuffle-tools probe: socket.create_connection(('iriswebapp_nginx',8443),timeout=8) succeeded (tcp_connect_8443=true). The action connected to the IRIS listener and completed the POST (ROUTED/200).
