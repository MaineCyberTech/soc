**Report ID:** phase57-030-swarm-secret-map
**Phase:** 57
**Title:** Swarm Secret Map
**Date:** 2026-08-28
**Timestamp:** 2026-08-28T03:54:26Z
**Classification:** INTERNAL
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-030-swarm-secret-map.md
...
## Evidence (layered)
Secret iris-shuffle-env (id 4vpfvc92ice0) mounted in shuffle-tools /run/secrets/iris-shuffle.env (ro). Backed by /shuffle-files fallback. Service-scoped, not in repo.
