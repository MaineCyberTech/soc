# Phase 74: Rest Tls 02

**Report ID:** phase74-221-rest-tls-02
**Phase:** 74
**Title:** Rest Tls 02
**Date:** 2026-08-29
...
**Status:** BLOCKED
**Source Path:** ops/reports/generated/phase74/221-rest-tls-02.md
...
## Evidence
OpenSearch REST TLS is NOT enabled on the dedup endpoint (plain HTTP on the mct-security gateway). Enabling REST TLS changes the security/TLS posture and is BLOCKED (requires owner sign-off); a signed exception remains OPEN per acceptance #6. Recorded, not fabricated.
