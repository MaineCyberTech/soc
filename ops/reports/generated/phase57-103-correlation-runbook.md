**Report ID:** phase57-103-correlation-runbook
**Phase:** 57
**Title:** Correlation Runbook
**Date:** 2026-08-28
**Timestamp:** 2026-08-28T03:54:26Z
**Classification:** INTERNAL
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-103-correlation-runbook.md
...
## Evidence (layered)
Runbook: inject level>=10 alert; capture Wazuh alert id + Shuffle exec id + IRIS object id.
