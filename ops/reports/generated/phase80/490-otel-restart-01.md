# Phase 80 OTel Report — Otel Restart

Report ID: 490-otel-restart-01
Phase:80
Title: Otel Restart
Date:2026-08-30
...
Status: PASS
Source Path: /home/user/mct-p80/prompts/490-otel-restart-01.md
Prompt: 490-otel-restart-01.md
...
## Summary
Restart survival confirmed. With the backend hung, 100001 spans were queued to the persistent (file_storage) queue on disk; after `docker restart` the on-disk queue was preserved (du unchanged across restart) and, on recovery, all 100001 spans exported. restart_survival=true.
