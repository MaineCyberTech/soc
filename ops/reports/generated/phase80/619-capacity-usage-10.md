...
Report ID : 619
Phase     : 80
Title     : Phase 80 Capacity Usage 10
Date      : 2026-08-30
...
Prompt    : /home/user/mct-p80/prompts/619-capacity-usage-10.md
===================================================================

STATUS: PASS — validator p80-capacity-validate.py: PASS (all 12 required keys present and non-empty).

Current measured usage observed from the live Wazuh indexer cluster (3-node, green). supported_limit=200.6 GB; current_usage=21.63 GB index store; remaining_capacity=178.97 GB. Cluster total documents=49,457,362 (~49.46M). Consumption rate: ≈7.2 docs/s (≈625,000 alerts/day ingested, measured 60s window 49456928→49457362 docs); ≈0.27 GB/day index-store growth (49.46M docs = 21.63 GB ≈0.43 KB/doc). Validator PASS. Source evidence: ops/reports/evidence/phase80/phase80-evidence-capacity.json.
