**Report ID:** phase57-087-iris-http
**Phase:** 57
**Title:** Iris Http
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-087-iris-http.md
...
## Evidence (layered)
IRIS HTTP POST iriswebapp_nginx:8443/alerts/add; value-blind token; 200.
