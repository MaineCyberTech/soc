...
```
$ curl -s -k -u admin:[REDACTED-PW] -H 'Content-Type: application/json' \
...
```
$ curl -s -k -u admin:[REDACTED-PW] ".../wazuh-archives-4.x-2026.08.25/_count?q=suricata"
{"count":271,...}
```
...
curl -s -k -u admin:[REDACTED-PW] "https://127.0.0.1:9200/wazuh-archives-4.x-2026.08.26/_count?q=suricata"

# I2 sample doc with full _source (must show intact data.* branches)
curl -s -k -u admin:[REDACTED-PW] "https://127.0.0.1:9200/wazuh-archives-4.x-2026.08.26/_search?size=1&q=suricata&pretty"
