**Report ID:** phase57-041-credential-scope
**Phase:** 57
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-041-credential-scope.md
...
## Evidence (layered)
IRIS credential scope = IRIS alert creation; iris-shuffle-env service-scoped to shuffle-tools. No lateral use.
