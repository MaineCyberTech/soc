# Phase 55: Two Sensor — policy

**Report ID:** phase55-154-two-sensor
**Phase:** 55
**Title:** Two Sensor — policy
**Date:** 2026-08-27
**Timestamp (UTC):** 2026-08-27T23:30:00Z
**Classification:** INTERNAL
**Status:** PARTIAL
**Source Path:** /home/user/mct-p55/prompts/154-two-sensor.md
**Prompt:** 154-two-sensor
**Generated (UTC):** 2026-08-27T23:30:00Z
**Operator (EDT):** 2026-08-27T19:30:00-0400
**Verdict:** PARTIAL

## Summary
Policy observation: the dedup key is (sid,src,dst,port) with no sensor/agent dimension. Two different sensors reporting the same 5-tuple will have the second marked DUPLICATE and only one ROUTED to IRIS. This is the current anti-replay policy but means distinct-sensor duplicates are collapsed (potential missed attribution).
...
## Limitations
- FND-3: identical 5-tuple from two sensors → second DUPLICATE (single ROUTED).
- Live re-exercise gated at production routing; behavior verified by code.

## Verdict rationale
PARTIAL: two-sensor same-5-tuple collapses to one alert by design (anti-replay). Noted as a policy limitation; changing it requires including a sensor dimension (owner-gated enhancement).
