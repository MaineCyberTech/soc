# Phase 55: Restart Policy

**Prompt:** 085-restart-policy
**Generated (UTC):** 2026-08-27T23:05:00Z
**Operator (EDT):** 2026-08-27T19:05:00-0400
**Verdict:** DONE

## Summary
RestartPolicy = Condition any, Delay 5s, MaxAttempts 0 (unlimited retries). Container restarts on any failure with 5s backoff, no cap. Ensures self-heal while preserving the secret mount (mount is part of task template, reapplied on restart).
...
Relevant: EV-SPEC-002 (RestartPolicy).
...
## Verdict rationale
Restart policy captured from live Spec.
