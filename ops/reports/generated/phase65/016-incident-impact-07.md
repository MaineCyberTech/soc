# Phase 65: Incident Impact 07

**Report ID:** phase65-016-incident-impact-07
**Phase:** 65
**Title:** Incident Impact 07
**Date:** 2026-08-28
**Timestamp:** 2026-08-28T20:22:54Z (UTC) / 2026-08-28 16:22:54 EDT (America/New_York)
**Classification:** INTERNAL
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase65/016-incident-impact-07.md
...
## Evidence
Phase 65 incident = discovery that the Wazuh->Shuffle->IRIS delivery leg is non-functional in production: (1) ossec.conf integration hook_url 'http://shuffle-backend:5001' is a swarm service name not resolvable from the manager container (all gateway IPs return HTTP 000); (2) the live integration api_key is the literal placeholder SHUFFLE_API_KEY_PLACEHOLDER; (3) the webhook webhook_e3fec000-555f-4e81-9497-77b7c91c5b98 is not linked to the Class-A workflow (0 executions). Impact: a genuine Wazuh alert is generated and forwarded by integratord (HTTP 200) but does NOT create an IRIS alert through this path. Remediation: temporarily connected the mct-security network + injected the real key to prove the Wazuh->Shuffle leg, then FULLY reverted. Bounded; no production alert loss.
