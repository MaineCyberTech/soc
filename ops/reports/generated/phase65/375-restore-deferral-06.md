# Phase 65: Restore Deferral 06

**Report ID:** phase65-375-restore-deferral-06
**Phase:** 65
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase65/375-restore-deferral-06.md
...
## Evidence
Full restore remains an APPROVED DEFERRAL (2026-08-28): NOT required to be tested now; DR environment future. Review triggers: any change to IRIS token, Shuffle workflow definition, or ossec.conf integratord hooks re-opens the gate.
