# Phase 65: Watchdog Invalid 05

**Report ID:** phase65-084-watchdog-invalid-05
**Phase:** 65
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase65/084-watchdog-invalid-05.md
...
## Evidence
Watchdog recovers integratord with valid config (no manager outage) and fails closed on invalid config (integratord count 0, others up). Single supervisor certified (s6 pid 2225). cleanup_stale added to governed source prevents stale-lock wedging.
