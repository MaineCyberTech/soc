# Phase 81: Capacity Resource Map 5

**Report ID:** 594
**Phase:** 81
**Title:** Phase 81: Capacity Resource Map 5
**Date:** 2026-08-31
...
**Prompt:** prompts/594-capacity-resource-map-05.md

## Objective

Separate Shuffle app-run entitlement, OpenSearch/host storage capacity, OTel queue storage, memory, CPU, and network capacity into independent resources. Work item 5 of 10 in the Phase 81 `capacity-resource-map` group.
