# Phase 81: Secured Reapply 10

**Report ID:** 269-secured-reapply-10
**Phase:** 81
**Title:** Phase 81: Secured Reapply 10
**Date:** 2026-08-31
**Timestamp:** 2026-08-31T04:33:12Z (UTC)
**Timestamp (America/New_York):** 2026-08-31T00:33:12 EDT
**Classification:** INTERNAL
**Status:** PASS
**Source Path:** /opt/mct-security-stack/ops/reports/generated/phase81/269-secured-reapply-10.md
**Prompt:** 269-secured-reapply-10.md

## Verdict
PASS — Phase 81 secured reapply reconciliation (work item 10 of 10) executed and certified against
...
## Scope
Secured reapplication reconciliation for the Phase 81 RECOVERY reconciliation. Operator approval granted for publication of the Phase 80
...
## Group Findings
- secured_reapply=true published in ops/reports/evidence/phase81/phase81-evidence-recovery.json, carrying Phase 80 ops/reports/evidence/phase80/secured-reapply.json: reapply_rbac_write_rc=201, reapply_rbac_delete_rc=403, dedicated service-scoped secrets present (iris-shuffle-dedicated, dedup-shuffle-dedicated, iris-ca.crt, opensearch-ca).
- object_650_post_reapply=true: the post-secured-reapply strict E2E canary (Wazuh -> Shuffle action task -> IRIS direct item-detail read-back) succeeded after the reapply, tracked as object_650 in ops/reports/evidence/phase81/phase81-evidence-provenance.json (Phase 80 post_reapply_e2e=true).
- Reapplied configuration is identity-pinned by config_sha256=9d9db0841dcbb642bfae24b322f94330780e70639ae0c59cace567ca4d8599a3 over integrations/shuffle/workflows/wazuh-high-severity-to-iris-execute_python-v2.py.
