# Phase 81: App Run Usage 7

**Report ID:** 616
**Phase:** 81
**Title:** Phase 81: App Run Usage 7
**Date:** 2026-08-31
...
**Prompt:** prompts/616-app-run-usage-07.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 7 of 10 in the Phase 81 `app-run-usage` group.
