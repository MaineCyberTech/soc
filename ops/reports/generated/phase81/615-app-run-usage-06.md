# Phase 81: App Run Usage 6

**Report ID:** 615
**Phase:** 81
**Title:** Phase 81: App Run Usage 6
**Date:** 2026-08-31
...
**Prompt:** prompts/615-app-run-usage-06.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 6 of 10 in the Phase 81 `app-run-usage` group.
