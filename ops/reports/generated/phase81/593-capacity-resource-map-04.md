# Phase 81: Capacity Resource Map 4

**Report ID:** 593
**Phase:** 81
**Title:** Phase 81: Capacity Resource Map 4
**Date:** 2026-08-31
...
**Prompt:** prompts/593-capacity-resource-map-04.md

## Objective

Separate Shuffle app-run entitlement, OpenSearch/host storage capacity, OTel queue storage, memory, CPU, and network capacity into independent resources. Work item 4 of 10 in the Phase 81 `capacity-resource-map` group.
