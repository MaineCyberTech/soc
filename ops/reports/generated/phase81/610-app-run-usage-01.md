# Phase 81: App Run Usage 1

**Report ID:** 610
**Phase:** 81
**Title:** Phase 81: App Run Usage 1
**Date:** 2026-08-31
...
**Prompt:** prompts/610-app-run-usage-01.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 1 of 10 in the Phase 81 `app-run-usage` group.
