# Phase 81: App Run Usage 8

**Report ID:** 617
**Phase:** 81
**Title:** Phase 81: App Run Usage 8
**Date:** 2026-08-31
...
**Prompt:** prompts/617-app-run-usage-08.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 8 of 10 in the Phase 81 `app-run-usage` group.
