# Phase 81: App Run Usage 3

**Report ID:** 612
**Phase:** 81
**Title:** Phase 81: App Run Usage 3
**Date:** 2026-08-31
...
**Prompt:** prompts/612-app-run-usage-03.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 3 of 10 in the Phase 81 `app-run-usage` group.
