# Phase 81: App Run Usage 9

**Report ID:** 618
**Phase:** 81
**Title:** Phase 81: App Run Usage 9
**Date:** 2026-08-31
...
**Prompt:** prompts/618-app-run-usage-09.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 9 of 10 in the Phase 81 `app-run-usage` group.
