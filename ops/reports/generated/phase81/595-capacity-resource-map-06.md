# Phase 81: Capacity Resource Map 6

**Report ID:** 595
**Phase:** 81
**Title:** Phase 81: Capacity Resource Map 6
**Date:** 2026-08-31
...
**Prompt:** prompts/595-capacity-resource-map-06.md

## Objective

Separate Shuffle app-run entitlement, OpenSearch/host storage capacity, OTel queue storage, memory, CPU, and network capacity into independent resources. Work item 6 of 10 in the Phase 81 `capacity-resource-map` group.
