# Phase 81: Capacity Resource Map 2

**Report ID:** 591
**Phase:** 81
**Title:** Phase 81: Capacity Resource Map 2
**Date:** 2026-08-31
...
**Prompt:** prompts/591-capacity-resource-map-02.md

## Objective

Separate Shuffle app-run entitlement, OpenSearch/host storage capacity, OTel queue storage, memory, CPU, and network capacity into independent resources. Work item 2 of 10 in the Phase 81 `capacity-resource-map` group.
