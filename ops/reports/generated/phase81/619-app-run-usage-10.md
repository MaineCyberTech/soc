# Phase 81: App Run Usage 10

**Report ID:** 619
**Phase:** 81
**Title:** Phase 81: App Run Usage 10
**Date:** 2026-08-31
...
**Prompt:** prompts/619-app-run-usage-10.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 10 of 10 in the Phase 81 `app-run-usage` group.
...
Live app-run usage counters (`org_statistics-000001`, doc
