# Phase 81: App Run Usage 4

**Report ID:** 613
**Phase:** 81
**Title:** Phase 81: App Run Usage 4
**Date:** 2026-08-31
...
**Prompt:** prompts/613-app-run-usage-04.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 4 of 10 in the Phase 81 `app-run-usage` group.
