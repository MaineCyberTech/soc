# Phase 81: App Run Usage 2

**Report ID:** 611
**Phase:** 81
**Title:** Phase 81: App Run Usage 2
**Date:** 2026-08-31
...
**Prompt:** prompts/611-app-run-usage-02.md

## Objective

Measure current app-run usage, remaining executions, per-workflow consumption, retries, canaries, and monitors. Work item 2 of 10 in the Phase 81 `app-run-usage` group.
