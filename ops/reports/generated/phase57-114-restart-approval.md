**Report ID:** phase57-114-restart-approval
**Phase:** 57
...
**Status:** BLOCKED
**Source Path:** ops/reports/generated/phase57-114-restart-approval.md
...
## Evidence (layered)
Applying integratord auto-heal = restart gate; BLOCKED pending owner approval.

## Stop conditions
Stop: integratord auto-heal = restart gate; owner approval required.
