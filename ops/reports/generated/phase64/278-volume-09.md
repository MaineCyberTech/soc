...
**Report ID:** phase64-278-volume-09
**Phase:** 64
**Title:** Volume 09
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase64/278-volume-09.md
...
## Evidence
Volume/disk: disk-watermark enforcement ENABLED (cluster.routing.allocation.disk.threshold_enabled=true, persistent), all 3 indexer nodes at 67% used (below 85/90/95). Disks PASS; no rollover action.
