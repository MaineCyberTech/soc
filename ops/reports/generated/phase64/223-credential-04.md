# Phase 64: Credential 04

**Report ID:** phase64-223-credential-04
**Phase:** 64
**Title:** Credential 04
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase64/223-credential-04.md
...
## Evidence
Evidence-based credential classification. IRIS token = rotated value-blind secret (prefix c2173178) read from iris-shuffle-env in-memory; ossec.conf api_keys masked in governed source. No literal secret in repo.
