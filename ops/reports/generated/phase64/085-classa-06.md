...
**Report ID:** phase64-085-classa-06
**Phase:** 64
**Title:** Classa 06
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase64/085-classa-06.md
...
## Evidence
Class-A correlation: one level>=10 Wazuh alert -> integratord -> hook_webhook_e3fec000-555f-4e81-9497-77b7c91c5b98 -> Shuffle c6b3fcd8-13e5-44a8-a818-024e4ae4422b -> IRIS. Recovery canary exec 8e62a17a-82c1-4de4-bb54-7712a290bb13 -> ROUTED 200; IRIS alert 134 read back (source wazuh, class A). phase64-correlation.json links wazuh_alert_id, integratord_record_id, hook_id, shuffle_execution_id, workflow_revision, iris_object_id, marker_match, object_readback.
