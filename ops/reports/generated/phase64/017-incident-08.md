# Phase 64: Incident 08

**Report ID:** phase64-017-incident-08
**Phase:** 64
**Title:** Incident 08
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase64/017-incident-08.md
...
## Evidence
Formal Wazuh manager outage incident (2026-08-28, Phase 63 kill-switch test): root cause = config ownership corruption (1000:1000) introduced by raw docker cp restore; impact = all Wazuh daemons stopped reading config ('Error reading XML file etc/ossec.conf line 0'); recovery = chown root:wazuh 640 + wazuh-control start; corrective action = staged-deploy validation + kill-switch runbook ownership requirement. Change linkage: P63 kill-switch/rollback test. Impact windows measured and bounded; no real production alert loss observed (authorized test window).
