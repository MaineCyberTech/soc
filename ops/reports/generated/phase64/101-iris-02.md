...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase64/101-iris-02.md
...
## Evidence
Independent IRIS read-back PROVEN: GET /alerts/134 (governed iris-shuffle-env token) returned success, source wazuh, class A, status New. Direct API read, not the workflow response.
