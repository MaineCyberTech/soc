...
**Prompt:** 222-allowlist
**Generated (UTC):** 2026-08-27T23:05:00Z
**Operator (EDT):** 2026-08-27T19:05:00-0400
**Verdict:** PARTIAL

## Summary
Routing is SID-scoped: the inspected execution argument and ROUTED result are keyed to `signature_id:2027967` (EV-SID-01, EV-ROUTE-01). No separate, versioned, exact-match allowlist artifact was discovered on the live surface or in repo references during this read-only pass; the allowlist is effectively the SID-2027967 trigger match.
...
## Limitations
No dedicated versioned allowlist file/object located (UNVERIFIED). SID-scoped match is the only allowlist evidence observed.

## Verdict rationale
PARTIAL: SID-scoped routing verified as the de-facto allowlist; a separately governed, versioned allowlist artifact is not present/UNVERIFIED.
