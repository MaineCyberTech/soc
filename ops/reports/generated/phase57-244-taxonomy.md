**Report ID:** phase57-244-taxonomy
**Phase:** 57
**Title:** Taxonomy
**Date:** 2026-08-28
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase57-244-taxonomy.md
...
## Evidence (layered)
Taxonomy: source:wazuh/class:A (real) vs source:suricata,class:A,test:true (synthetic).
