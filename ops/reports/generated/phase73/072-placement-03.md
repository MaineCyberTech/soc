# Phase 73: Placement 03

**Report ID:** phase73-072-placement-03
**Phase:** 73
**Title:** Placement 03
**Date:** 2026-08-29
...
**Status:** VERIFIED
**Source Path:** ops/reports/generated/phase73/072-placement-03.md
...
## Evidence
Action network durability: committed in Swarm desired state (compose sha 916e6b49bcff); shuffle-tools shares overlay mct-security with iriswebapp_nginx (stable_dns verified, resolves post-reschedule); observed rescheduled >=2x; post-reschedule strict E2E canary (object 213) ROUTED 200 and read back via dedup ledger. OPEN: node_evacuation (drain a node) and rolling-update/rollback were NOT performed -- authorized infrastructure operations. A transient DNS/IRIS fault this session (orphaned object 214: created without persisted dedup record) is retained as real-fault evidence and motivates the outbox pattern.
