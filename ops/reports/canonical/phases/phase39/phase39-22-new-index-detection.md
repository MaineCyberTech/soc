...
```
curl -s -k -u admin:P@ssw0rd@ "https://127.0.0.1:9200/_cat/indices/wazuh-archives-*?v&h=index,creation.date.string,docs.count" | sort | tail -2
```
...
curl -s -k -u admin:P@ssw0rd@ -XPOST "https://127.0.0.1:9200/_index_template/_simulate_index/wazuh-archives-4.x-2026.08.27"

# b) live settings on 08.26 itself (authoritative; this is the phase39-23 gate)
curl -s -k -u admin:P@ssw0rd@ "https://127.0.0.1:9200/wazuh-archives-4.x-2026.08.26/_settings?flat_settings=true&pretty"
```
