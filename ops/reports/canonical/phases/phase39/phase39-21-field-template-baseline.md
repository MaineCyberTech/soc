...
```
$ curl -s -k -u admin:P@ssw0rd@ "https://127.0.0.1:9200/_index_template/wazuh-archives-fieldlimit" | python3 -m json.tool
```
...
```
$ curl -s -k -u admin:P@ssw0rd@ "https://127.0.0.1:9200/_index_template" \
...
```
$ curl -s -k -u admin:P@ssw0rd@ "https://127.0.0.1:9200/_cat/indices/wazuh-archives-*?v&h=index,creation.date.string" | sort | tail -3
